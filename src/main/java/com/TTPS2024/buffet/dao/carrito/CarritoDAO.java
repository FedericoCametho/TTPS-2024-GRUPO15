...
@Repository
public class CarritoDAO implements JpaRepository<Carrito, Long> {
    ...
    @Override
    public Carrito getOne(Long aLong) {
        return null;
    }

    @Override
    public Carrito getById(Long aLong) {
        return null;
    }

    @Override
    public Carrito getReferenceById(Long aLong) {
        return null;
    }
    ...
    @Override
    public Optional<Carrito> findById(Long aLong) {
        return Optional.empty();
    }
    ...
    @Override
    public List<Carrito> findAllById(Iterable<Long> longs) {
        return null;
    }
